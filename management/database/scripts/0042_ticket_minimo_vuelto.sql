-- Script: 0042_ticket_minimo_vuelto.sql
-- App Origen: NotificaPe_Specs / db
-- Autor: AGENT_ROLE (Orquestador SDD / Arquitecto Principal)
-- Fecha: 2026-09-03
-- Justificación: [CR-014] Inyección automática del diferencial (Vuelto) como saldo a favor (Créditos) cuando se aplica el Ticket Mínimo de pasarela (S/ 5.00) en compras de licencias/addons.
...
BEGIN
  ...
  -- 4.1 Inyección de Vuelto / Saldo a favor por Ticket Mínimo de Pasarela
...
GRANT EXECUTE ON FUNCTION public.ejecutar_compra_licencia_multiple(UUID, SMALLINT, BOOLEAN, VARCHAR, BIGINT, CHAR, TEXT, VARCHAR, TEXT, INT, INT, INT, INT) TO service_role;
