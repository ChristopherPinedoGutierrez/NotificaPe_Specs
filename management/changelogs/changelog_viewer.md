...
* **Descripci�n:** Optimizaci�n y Estabilizaci�n del Orquestador Realtime para evitar bucles infinitos de reconexi�n y cierres silenciosos (OOM/ANR).
* **Detalles T�cnicos:**
...
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: La reconexi�n delega en el backoff exponencial de Supabase evitando bucles de hardReset autom�ticos en background.
  - [x] AC 2: Se despiertan los canales ZOMBIE correctamente al pasar a Foreground.
  - [x] AC 3: El canal de vibraci�n y voz no acumula elementos infinitos ni produce ANR.
---

---
### [2026-07-24 21:30] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Implementaci�n de opci�n configurable para Notificaciones Emergentes Pop-Up (Heads-Up) sobre otras aplicaciones.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Adici�n del Switch  Alertas Emergentes Pop-Up en la pesta�a de Configuraci�n.
  - [x] AC 2: Creaci�n del canal de alta importancia (ALERTS_HEADS_UP_CHANNEL_ID) para proyectar tarjetas flotantes sobre otras apps.
  - [x] AC 3: Preservaci�n de la preferencia persistente en DataStore (isHeadsUpEnabled).
---

---
### [2026-07-24 22:10] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Redise�o UI/UX con Carrusel de Encabezado con flechas e �conos de informaci�n contextual (i) con di�logos modales.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Creaci�n de CarouselHeader e InfoExplanationDialog en CommonHomeComponents.kt.
  - [x] AC 2: Reemplazo de sub-pesta�as en Notificaciones por carrusel navegable con t�tulos explicativos ( Disponibles para Reclamar y Tomadas por Otros Vendedores).
  - [x] AC 3: Renombrado de pesta�as principales en Mi Registro (Mis Ventas y Pagos en Conflicto) y carrusel de sub-estados (En Revisi�n por Admin, Resueltos a Mi Favor, Asignados a Otro Vendedor).
---

---
### [2026-07-24 22:21] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Refinamiento de dise�o UI/UX: Carrusel Full-Width de borde a borde (sin m�rgenes ni aspecto de bot�n) y unificaci�n total en Mi Registro.
* **Detalles T�cnicos:**
  - **Archivos Modificados:** [CommonHomeComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/CommonHomeComponents.kt), [NotificacionComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/NotificacionComponents.kt), [ControlComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/ControlComponents.kt)
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Redise�o de CarouselHeader para extenderse de borde a borde de la pantalla (full-width).
  - [x] AC 2: Eliminaci�n de TabRow tradicional en Mi Registro e integraci�n de carrusel Nivel 1 ( Mis Ventas del D�a vs Pagos en Conflicto).
  - [x] AC 3: Mantenimiento de carrusel Nivel 2 en Pagos en Conflicto con di�logos informativos contextuales.
---

---
### [2026-07-24 22:33] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Eliminaci�n de �cono (i), aplicaci�n de color morado tem�tico en Nivel 1 de Mi Registro y soluci�n a bug de visibilidad de notificaciones por isNullOrBlank.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Eliminaci�n del bot�n (i) y ventana modal InfoExplanationDialog en CarouselHeader.
  - [x] AC 2: Aplicaci�n del color morado (primary) en el carrusel de nivel 1 de Mi Registro.
  - [x] AC 3: Correcci�n de la validaci�n IdUsuarioGanador.isNullOrBlank() en HomeStateProvider.kt haciendo visibles los pagos disponibles.
---

---
### [2026-07-24 23:12] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Ajustes de UI: Color azul en Pagos en Conflicto y expansi�n de ancho de modales HomeDetailModal a casi todo el ancho de pantalla.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Aplicaci�n del color azul (0xFF2196F3) a Pagos en Conflicto en el nivel 1 de Mi Registro.
  - [x] AC 2: Configuraci�n de DialogProperties(usePlatformDefaultWidth = false) en HomeDetailModal expandiendo el ancho con m�rgenes de 20dp.
---

---
### [2026-07-24 23:26] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Reordenamiento de navegacion principal (Notificaciones primero por defecto, Mi Registro segundo) y hardware de dispositivo actual en Configuraci�n.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Reordenamiento de barra de navegaci�n: Notificaciones (0), Mi Registro (1), Configuraci�n (2).
  - [x] AC 2: Notificaciones se establece como la vista inicial por defecto al ingresar a la pantalla principal.
  - [x] AC 3: Hardware en Informaci�n del Sistema muestra la marca y modelo en vivo del dispositivo en uso (Build.MANUFACTURER y Build.MODEL).
---

---
### [2026-07-24 23:36] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Adici�n de indicador de vista/p�gina tipo pill (1/2, 2/2 en Nivel 1 y 1/3, 2/3, 3/3 en Nivel 2) en todos los carruseles.
* **Detalles T�cnicos:**
  - **Archivos Modificados:** [CommonHomeComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/CommonHomeComponents.kt), [NotificacionComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/NotificacionComponents.kt), [ControlComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/ControlComponents.kt)
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Implementaci�n del par�metro pageIndicator en CarouselHeader renderizando una pill discreta.
...
* **Descripci�n:** Reemplazo de indicadores numericos (1/2, 1/3) por iconos tematicos al inicio del titulo en los carruseles.
* **Detalles T�cnicos:**
  - **Archivos Modificados:** [CommonHomeComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/CommonHomeComponents.kt), [NotificacionComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/NotificacionComponents.kt), [ControlComponents.kt](file:///c:/Trabajo/Proyectos/NotificaPe/viewer/app/src/main/java/com/notificape/viewer/ui/home/components/ControlComponents.kt)
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Reemplazo del par�metro pageIndicator por leadingIcon: ImageVector en CarouselHeader.
...
* **Descripci�n:** Migraci�n del Foreground Service de dataSync a specialUse para evadir restricciones de 6 horas en Android 14.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Compilaci�n exitosa del build de Debug.
  - [x] AC 2: Prevenci�n del crash ForegroundServiceDidNotStopException.
---

---
### [2026-07-31 23:45] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripción:** Implementación de resiliencia en reconexión de Realtime (Doze Mode) y cambio de título de notificación persistente.
* **Detalles Técnicos:**
...
* **Descripción:** Implementación de flujo alternativo de Login Manual para revisión en Google Play Console.
* **Detalles Técnicos:**
  ...
  - **Base de Datos:** Se generó el script 0040_viewer_bypass_account.sql para inyectar la cuenta google-review@notificape.pe en auth.users, public.Usuarios y AutorizacionesXUsuario.
* **Criterios de Aceptación (AC) Validados:**
  - [x] AC 1: La UI de Login puede intercambiarse condicionalmente a una vista manual.
  - [x] AC 2: Se implementó autenticación por email con Supabase Auth respetando el enrutamiento reactivo de la app.
---

---
### [2026-08-17 16:40] | App/Componente: Viewer | Autor: AGENT_ROLE

* **Descripci�n:** Refinamiento de acentos visuales y opacidades (Verde Esmeralda) en dashboard y componentes comunes para diferenciar identidad de Viewer.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Ninguno
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: Componentes seleccionados aplican color secundario (Verde) con contraste sem�ntico.
