...
* **Descripci髇:** Correcci髇 del mapeo del par醡etro tipoFiltro en el simulador TestLabHandler para asegurar la correcta inyecci髇 y funcionamiento de las reglas de EXCLUSI覰 en los tests locales, y explicaci髇 arquitectural del filtro visual de privacidad para notificaciones en estado REVISION.
* **Detalles T閏nicos:**
...
* **Criterios de Aceptaci髇 (AC) Validados:**
  ...
  - [x] AC 2: La compilaci髇 Kotlin/KSP fue exitosa.
---
