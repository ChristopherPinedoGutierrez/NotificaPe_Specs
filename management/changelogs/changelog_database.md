...
* **Descripci�n:** Modificaci�n de prorrateo para add-ons en licencias, compras mixtas y motor de colas pg_cron.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** A�adidas columnas ExtraUsuarios y ExtraDispositivos a LicenciasCola. Actualizadas RPC previsualizar_compra_licencia y ejecutar_compra_licencia_multiple. Creada RPC procesar_licencias_cola programada diariamente a las 00:01 con pg_cron.
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: La actualizaci�n del c�digo de prorrateo no borra los valores de extras previos y retrocompatibilidad con apps Android verificada.
  - [x] AC 2: El motor de colas con pg_cron qued� instalado y programado correctamente a las 00:01 en Supabase.
---

---
### [2026-08-09 14:00] | App/Componente: db | Autor: Antigravity

* **Descripción:** Hard delete de Agora e inyección de reglas de inclusión V2 y exclusiones categorizadas (6 registros) para Yape.
* **Detalles Técnicos:**
...
* **Descripci�n:** Inyecci�n de payload detallado en el trigger de autorizaciones para Viewer.
* **Detalles T�cnicos:**
  ...
  - **Base de Datos:** Modificaci�n in-place de la funci�n fn_dispatch_fcm_viewer para incluir jsonb data_payload.
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: SYNC_AUTH notifica estado, id de dispositivo y autorizaci�n afectados.
---
...
* **Descripci�n:** Enriquecimiento del payload FCM con nombres de negocio y dispositivo.
* **Detalles T�cnicos:**
  - **Archivos Modificados:** [0044_fcm_tokens_viewer.sql](file:///C:/Trabajo/Proyectos/NotificaPe/NotificaPe_Specs/management/database/scripts/0044_fcm_tokens_viewer.sql)
  - **Base de Datos:** SELECT JOIN a�adido para extraer AliasDispositivo y NombreNegocio de la caja afectada.
* **Criterios de Aceptaci�n (AC) Validados:**
  - [x] AC 1: SYNC_AUTH env�a informaci�n contextual completa.
---
